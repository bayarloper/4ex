...
export function HeroChart() {
  ...
  return (
    <div className="relative bg-card/50 backdrop-blur-sm border border-border rounded-2xl p-6 shadow-2xl w-full max-w-lg mx-auto hover:scale-[1.02] transition-transform duration-500 overflow-hidden group animate-fade-in-up delay-200">
      {/* Background Grid */}
